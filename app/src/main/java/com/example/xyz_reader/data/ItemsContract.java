package com.example.xyz_reader.data;

import android.net.Uri;

public class ItemsContract {
    public static final String CONTENT_AUTHORITY = "com.example.xyz_reader";
    public static final Uri BASE_URI = Uri.parse("content://com.example.xyz_reader");
    ...
    public static class Items implements ItemsColumns {
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.com.example.xyz_reader.items";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.com.example.xyz_reader.items";
